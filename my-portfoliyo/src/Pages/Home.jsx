...
<a
  href="#contact"
  className="relative group px-6 py-3 bg-blue-500/60 rounded-lg font-medium overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30"
>
  {/* 🔥 Animated Background */}
  <span className="absolute inset-0 bg-blue-600 scale-0 group-hover:scale-100 transition-transform duration-500 origin-bottom-left rounded-lg"></span>
  ...
  <span className="relative z-10 text-white tracking-wide">
    Let&apos;s Talk
                ...
                <a href="#project" className="px-6 py-3 border border-blue-400 hover:animate-bounce text-blue-200 rounded-lg hover:bg-blue-600/20 transition duration-100">
                  View Projects
                </a>
              </div >
              {/* media wala icon */}
              <div className="mt-5 flex flex-wrap gap-5 overflow-x-auto md:justify-start no-scrollbar">
              <button type="button" onClick={()=> window.open(linkedin,"_blank")} className="bg-blue-600 hover:bg-blue-800 hover:scale-110 px-4 py-2 rounded-lg hover:animate-bounce" ><FaLinkedin size={24} /></button>
              <button type="button" onClick={()=> window.open(whatsapp,"_blank")} className="bg-green-500 hover:bg-green-400 hover:scale-110 px-4 py-2 rounded-lg hover:animate-bounce" ><FaWhatsapp size={24} /></button>
              <button type="button" onClick={()=> window.open(instagram,"_blank")} className="bg-pink-500 hover:bg-pink-400 hover:text-red-700 hover:scale-110 transition-all duration-300 px-4 py-2 rounded-lg hover:animate-bounce"><FaInstagram size={24} /></button>
              <button type="button" onClick={()=> window.open(facebook,"_blank")} className="bg-blue-500   hover:bg-blue-900 hover:scale-110 px-4 py-2 rounded-lg  transition-all duration-300 hover:animate-bounce"><FaFacebook size={24} /></button>
              
              </div>

              <div className="mt-10 grid grid-cols-2 gap-3 max-w-md text-center text-white">
