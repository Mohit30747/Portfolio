...
export default function Project() {
  return (
    <motion.section
      ...
      className="min-h-screen bg-linear-to-b from-gray-950 to-gray-900 text-white py-16 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {projects.map((project) => (
            <article key={project.title} className="bg-gray-800/80 border border-gray-700 rounded-2xl p-5 hover:-translate-y-1 transition">
